...
class LocalDataSource {
  ...
  static final List<ServiceEntity> _services = [
    const ServiceEntity(
      id: 's1', name: 'NGO Registration', price: 4999,
      pricingLabel: '₹4,999', purchasable: true,
      status: 'approved', category: ServiceCategory.ngo,
      description: 'Complete NGO registration with all government formalities.',
      documents: ['PAN Card', 'Address Proof', 'MOA & AOA'],
      durationDays: 21,
    ),
    const ServiceEntity(
      id: 's2', name: 'Trust Registration', price: 5999,
      pricingLabel: '₹5,999', purchasable: true,
      status: 'approved', category: ServiceCategory.ngo,
    ...
    const ServiceEntity(
      id: 's3', name: 'Section 8 Company', price: 8999,
      pricingLabel: '₹8,999', purchasable: true,
      status: 'approved', category: ServiceCategory.ngo,
    ...
    const ServiceEntity(
      id: 's4', name: '12A Registration', price: 3999,
      pricingLabel: '₹3,999', purchasable: true,
      status: 'approved', category: ServiceCategory.compliance,
      description: 'Tax exemption registration for NGOs & trusts.',
      documents: ['Registration Certificate', 'MOA', 'IT Returns'],
      durationDays: 45,
    ),
    const ServiceEntity(
      id: 's5', name: '80G Registration', price: 3999,
      pricingLabel: '₹3,999', purchasable: true,
      status: 'approved', category: ServiceCategory.compliance,
    ...
    const ServiceEntity(
      id: 's6', name: 'GST Registration', price: 1999,
      pricingLabel: '₹1,999', purchasable: true,
      status: 'pending', category: ServiceCategory.business,
      description: 'Mandatory GST registration for eligible organizations.',
      documents: ['PAN', 'Aadhaar', 'Bank Statement'],
      durationDays: 7,
    ),
    const ServiceEntity(
      id: 's7', name: 'LLP Registration', price: 7999,
      pricingLabel: '₹7,999', purchasable: true,
      status: 'approved', category: ServiceCategory.business,
      description: 'Limited Liability Partnership formation.',
      documents: ['DPIN', 'DSC', 'LLP Agreement'],
      durationDays: 15,
    ),
    const ServiceEntity(
      id: 's8', name: 'Private Limited Co.', price: 9999,
      pricingLabel: '₹9,999', purchasable: true,
      status: 'approved', category: ServiceCategory.business,
    ...
    const ServiceEntity(
      id: 's9', name: 'Startup India Reg.', price: 2999,
      pricingLabel: '₹2,999', purchasable: true,
      status: 'pending', category: ServiceCategory.business,
    ...
    const ServiceEntity(
      id: 's10', name: 'FCRA Registration', price: 14999,
      pricingLabel: '₹14,999', purchasable: true,
      status: 'approved', category: ServiceCategory.ngo,
